article_parse_config = {
    ...
    "dota2ru_article": {
        ...
        "text_tag": ("span", "div"),
        "text_class": (
            "inserted-link inserted-link--tournament",
            "global-content p-content js-text-errors-wrap",
        ),
        "photo_tag": "div",
    ...
    "gamebomb_article": {
        "title_tag": "div",
        "title_class": "container-header",
        "time_tag": "div",
        "time_class": "content",
        "text_tag": "div",
        "text_class": "content container-margin",
        "photo_tag": "img",
        "photo_class": "bordered",
    },
}
...
link_parse_config = {
    ...
    "геймбомб.ру": {
        "homeurl": "https://gamebomb.ru",
        "все": {
            "url": "https://gamebomb.ru/news",
            "link_tag": "a",
            "link_class_name": "img",
            "article": article_parse_config["gamebomb_article"],
        },
    },
}
